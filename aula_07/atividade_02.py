...
# O pescador João, que atua na região costeira de Santa Catarina, procurou sua empresa de tecnologia para resolver uma necessidade que ele enfrenta no dia a dia. De acordo com o regulamento de pesca do estado, a quantidade máxima permitida de peixes por dia é de 100 quilos.
